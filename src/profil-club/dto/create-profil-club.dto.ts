...
export class CreateProfilClubDto {
    @ApiProperty({ description: 'The ID of the user associated with the Profil Club', example: 1 })
    @IsNumber()
    @IsNotEmpty()
    userId: number;
    ...
    @ApiProperty({ description: 'Domain or area of expertise', example: 'Technology' })
    @IsString()
    @IsNotEmpty()
    domaine: string;
